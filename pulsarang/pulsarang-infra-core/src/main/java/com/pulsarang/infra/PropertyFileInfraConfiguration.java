...
public class PropertyFileInfraConfiguration extends BasicInfraConfiguration {
	private final Logger log = LoggerFactory.getLogger(InfraConfiguration.class);
	...
	public PropertyFileInfraConfiguration() {
		this("pulsarang-config.properties");
	}

	public PropertyFileInfraConfiguration(String filePath) {
		...
		super.setSolutionName(getProperty(InfraParameters.SOLUTION_NAME, true));
		super.setProjectName(getProperty(InfraParameters.PROJECT_NAME, true));
