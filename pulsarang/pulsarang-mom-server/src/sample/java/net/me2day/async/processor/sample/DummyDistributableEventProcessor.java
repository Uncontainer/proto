/*
 * DummyDistributableEventProcessor.java $version 2010. 10. 15
 ...
 * @author pulsarang
 */
@Component(value = "dummyProcessor-1")
public class DummyDistributableEventProcessor implements ProcessingDistributableEventProcesssor,
	ConfigInitializeListener {
	...
	public DummyDistributableEventProcessor() {
