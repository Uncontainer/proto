...
public class StringLayout extends AbstractLayout {
	public static final String ALIAS = "string";

	public StringLayout(long targetResourceId) {
	...
	public int getExpectedWidth(Map<Long, Object> valueMap) {
		Object value = valueMap.get(targetResourceId);
		if (value == null) {
			return 10;
		}
