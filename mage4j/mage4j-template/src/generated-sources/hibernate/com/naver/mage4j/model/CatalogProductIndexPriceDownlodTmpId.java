...
/**
 * CatalogProductIndexPriceDownlodTmpId generated by hbm2java
 */
@Embeddable
public class CatalogProductIndexPriceDownlodTmpId implements java.io.Serializable {
	...
	public CatalogProductIndexPriceDownlodTmpId(int entityId, short customerGroupId, short websiteId) {
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof CatalogProductIndexPriceDownlodTmpId))
			return false;
		CatalogProductIndexPriceDownlodTmpId castOther = (CatalogProductIndexPriceDownlodTmpId)other;
