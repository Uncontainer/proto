...
/**
 * CatalogProductIndexPriceFinalTmpId generated by hbm2java
 */
@Embeddable
public class CatalogProductIndexPriceFinalTmpId implements java.io.Serializable {
	...
	public CatalogProductIndexPriceFinalTmpId(int entityId, short customerGroupId, short websiteId) {
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof CatalogProductIndexPriceFinalTmpId))
			return false;
		CatalogProductIndexPriceFinalTmpId castOther = (CatalogProductIndexPriceFinalTmpId)other;
