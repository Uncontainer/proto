...
/**
 * CatalogProductIndexPriceOptAgrTmpId generated by hbm2java
 */
@Embeddable
public class CatalogProductIndexPriceOptAgrTmpId implements java.io.Serializable {
	...
	public CatalogProductIndexPriceOptAgrTmpId(int entityId, short customerGroupId, short websiteId, int optionId) {
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof CatalogProductIndexPriceOptAgrTmpId))
			return false;
		CatalogProductIndexPriceOptAgrTmpId castOther = (CatalogProductIndexPriceOptAgrTmpId)other;
