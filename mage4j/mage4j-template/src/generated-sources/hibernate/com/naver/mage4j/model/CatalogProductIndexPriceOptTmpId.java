...
/**
 * CatalogProductIndexPriceOptTmpId generated by hbm2java
 */
@Embeddable
public class CatalogProductIndexPriceOptTmpId implements java.io.Serializable {
	...
	public CatalogProductIndexPriceOptTmpId(int entityId, short customerGroupId, short websiteId) {
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof CatalogProductIndexPriceOptTmpId))
			return false;
		CatalogProductIndexPriceOptTmpId castOther = (CatalogProductIndexPriceOptTmpId)other;
