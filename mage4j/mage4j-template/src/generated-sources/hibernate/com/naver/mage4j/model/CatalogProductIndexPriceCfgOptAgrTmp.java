...
/**
 * CatalogProductIndexPriceCfgOptAgrTmp generated by hbm2java
 */
@Entity
@Table(name = "catalog_product_index_price_cfg_opt_agr_tmp"
	, catalog = "magento")
public class CatalogProductIndexPriceCfgOptAgrTmp implements java.io.Serializable {

	private CatalogProductIndexPriceCfgOptAgrTmpId id;
	...
	public CatalogProductIndexPriceCfgOptAgrTmp(CatalogProductIndexPriceCfgOptAgrTmpId id) {
		this.id = id;
	}

	public CatalogProductIndexPriceCfgOptAgrTmp(CatalogProductIndexPriceCfgOptAgrTmpId id, BigDecimal price, BigDecimal tierPrice, BigDecimal groupPrice) {
		this.id = id;
		this.price = price;
	...
	public CatalogProductIndexPriceCfgOptAgrTmpId getId() {
		return this.id;
	}

	public void setId(CatalogProductIndexPriceCfgOptAgrTmpId id) {
		this.id = id;
	}
