...
/**
 * CatalogProductIndexPriceBundleSelIdxId generated by hbm2java
 */
@Embeddable
public class CatalogProductIndexPriceBundleSelIdxId implements java.io.Serializable {
	...
	public CatalogProductIndexPriceBundleSelIdxId(int entityId, short customerGroupId, short websiteId, int optionId, int selectionId) {
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof CatalogProductIndexPriceBundleSelIdxId))
			return false;
		CatalogProductIndexPriceBundleSelIdxId castOther = (CatalogProductIndexPriceBundleSelIdxId)other;
