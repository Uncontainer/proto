...
public class CustomerEavAttributeWebsite implements java.io.Serializable {
	...
	public CustomerEavAttributeWebsite(CustomerEavAttributeWebsiteId id, CoreWebsite coreWebsite, EavAttribute eavAttribute) {
		this.id = id;
		this.coreWebsite = coreWebsite;
		this.eavAttribute = eavAttribute;
	}

	public CustomerEavAttributeWebsite(CustomerEavAttributeWebsiteId id, CoreWebsite coreWebsite, EavAttribute eavAttribute, Short isVisible, Short isRequired, String defaultValue, Short multilineCount) {
		this.id = id;
		this.coreWebsite = coreWebsite;
		this.eavAttribute = eavAttribute;
