...
/**
 * CatalogProductIndexPriceOptAgrIdx generated by hbm2java
 */
@Entity
@Table(name = "catalog_product_index_price_opt_agr_idx"
	, catalog = "magento")
public class CatalogProductIndexPriceOptAgrIdx implements java.io.Serializable {

	private CatalogProductIndexPriceOptAgrIdxId id;
	...
	public CatalogProductIndexPriceOptAgrIdx(CatalogProductIndexPriceOptAgrIdxId id) {
		this.id = id;
	}

	public CatalogProductIndexPriceOptAgrIdx(CatalogProductIndexPriceOptAgrIdxId id, BigDecimal minPrice, BigDecimal maxPrice, BigDecimal tierPrice, BigDecimal groupPrice) {
		this.id = id;
	...
	public CatalogProductIndexPriceOptAgrIdxId getId() {
		return this.id;
	}

	public void setId(CatalogProductIndexPriceOptAgrIdxId id) {
		this.id = id;
	}
