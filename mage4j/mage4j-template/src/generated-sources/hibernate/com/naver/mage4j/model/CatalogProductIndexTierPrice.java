...
public class CatalogProductIndexTierPrice implements java.io.Serializable {
	...
	public CatalogProductIndexTierPrice(CatalogProductIndexTierPriceId id, CoreWebsite coreWebsite, CatalogProductEntity catalogProductEntity, CustomerGroup customerGroup) {
		this.id = id;
	...
	public CatalogProductIndexTierPrice(CatalogProductIndexTierPriceId id, CoreWebsite coreWebsite, CatalogProductEntity catalogProductEntity, CustomerGroup customerGroup, BigDecimal minPrice) {
		this.id = id;
		this.coreWebsite = coreWebsite;
		this.catalogProductEntity = catalogProductEntity;
		this.customerGroup = customerGroup;
