...
/**
 * CatalogProductIndexPriceTmpId generated by hbm2java
 */
@Embeddable
public class CatalogProductIndexPriceTmpId implements java.io.Serializable {
	...
	public CatalogProductIndexPriceTmpId(int entityId, short customerGroupId, short websiteId) {
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof CatalogProductIndexPriceTmpId))
			return false;
		CatalogProductIndexPriceTmpId castOther = (CatalogProductIndexPriceTmpId)other;
