...
/**
 * CatalogProductIndexPriceId generated by hbm2java
 */
@Embeddable
public class CatalogProductIndexPriceId implements java.io.Serializable {
	...
	public CatalogProductIndexPriceId(int entityId, short customerGroupId, short websiteId) {
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof CatalogProductIndexPriceId))
			return false;
		CatalogProductIndexPriceId castOther = (CatalogProductIndexPriceId)other;
