...
public class CatalogProductEntityMediaGalleryValue implements java.io.Serializable {
	...
	public CatalogProductEntityMediaGalleryValue(CatalogProductEntityMediaGalleryValueId id, CatalogProductEntityMediaGallery catalogProductEntityMediaGallery, CoreStore coreStore, short disabled) {
		this.id = id;
	...
	public CatalogProductEntityMediaGalleryValue(CatalogProductEntityMediaGalleryValueId id, CatalogProductEntityMediaGallery catalogProductEntityMediaGallery, CoreStore coreStore, String label, Integer position, short disabled) {
		this.id = id;
		this.catalogProductEntityMediaGallery = catalogProductEntityMediaGallery;
		this.coreStore = coreStore;
		this.label = label;
