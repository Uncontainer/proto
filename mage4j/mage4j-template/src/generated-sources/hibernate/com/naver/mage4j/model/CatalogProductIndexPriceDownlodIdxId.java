...
/**
 * CatalogProductIndexPriceDownlodIdxId generated by hbm2java
 */
@Embeddable
public class CatalogProductIndexPriceDownlodIdxId implements java.io.Serializable {
	...
	public CatalogProductIndexPriceDownlodIdxId(int entityId, short customerGroupId, short websiteId) {
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof CatalogProductIndexPriceDownlodIdxId))
			return false;
		CatalogProductIndexPriceDownlodIdxId castOther = (CatalogProductIndexPriceDownlodIdxId)other;
