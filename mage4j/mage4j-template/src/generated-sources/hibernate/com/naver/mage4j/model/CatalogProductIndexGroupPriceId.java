...
/**
 * CatalogProductIndexGroupPriceId generated by hbm2java
 */
@Embeddable
public class CatalogProductIndexGroupPriceId implements java.io.Serializable {

	private int entityId;
	private short customerGroupId;
	private short websiteId;

	public CatalogProductIndexGroupPriceId() {
	}

	public CatalogProductIndexGroupPriceId(int entityId, short customerGroupId, short websiteId) {
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof CatalogProductIndexGroupPriceId))
			return false;
		CatalogProductIndexGroupPriceId castOther = (CatalogProductIndexGroupPriceId)other;
