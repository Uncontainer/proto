...
/**
 * CatalogProductIndexPriceOptIdx generated by hbm2java
 */
@Entity
@Table(name = "catalog_product_index_price_opt_idx"
	, catalog = "magento")
public class CatalogProductIndexPriceOptIdx implements java.io.Serializable {

	private CatalogProductIndexPriceOptIdxId id;
	...
	public CatalogProductIndexPriceOptIdx(CatalogProductIndexPriceOptIdxId id) {
		this.id = id;
	}

	public CatalogProductIndexPriceOptIdx(CatalogProductIndexPriceOptIdxId id, BigDecimal minPrice, BigDecimal maxPrice, BigDecimal tierPrice, BigDecimal groupPrice) {
		this.id = id;
	...
	public CatalogProductIndexPriceOptIdxId getId() {
		return this.id;
	}

	public void setId(CatalogProductIndexPriceOptIdxId id) {
		this.id = id;
	}
