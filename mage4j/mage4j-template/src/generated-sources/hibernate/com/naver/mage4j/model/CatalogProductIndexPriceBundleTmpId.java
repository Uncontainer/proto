...
/**
 * CatalogProductIndexPriceBundleTmpId generated by hbm2java
 */
@Embeddable
public class CatalogProductIndexPriceBundleTmpId implements java.io.Serializable {
	...
	public CatalogProductIndexPriceBundleTmpId(int entityId, short customerGroupId, short websiteId) {
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof CatalogProductIndexPriceBundleTmpId))
			return false;
		CatalogProductIndexPriceBundleTmpId castOther = (CatalogProductIndexPriceBundleTmpId)other;
