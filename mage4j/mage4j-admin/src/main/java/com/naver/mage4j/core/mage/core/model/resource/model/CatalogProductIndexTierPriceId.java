...
/**
 * CatalogProductIndexTierPriceId generated by hbm2java
 */
@Embeddable
public class CatalogProductIndexTierPriceId implements java.io.Serializable {
	...
	public CatalogProductIndexTierPriceId(int entityId, short customerGroupId, short websiteId) {
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof CatalogProductIndexTierPriceId))
			return false;
		CatalogProductIndexTierPriceId castOther = (CatalogProductIndexTierPriceId)other;
