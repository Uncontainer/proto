...
/**
 * CatalogProductIndexPriceIdxId generated by hbm2java
 */
@Embeddable
public class CatalogProductIndexPriceIdxId implements java.io.Serializable {
	...
	public CatalogProductIndexPriceIdxId(int entityId, short customerGroupId, short websiteId) {
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof CatalogProductIndexPriceIdxId))
			return false;
		CatalogProductIndexPriceIdxId castOther = (CatalogProductIndexPriceIdxId)other;
