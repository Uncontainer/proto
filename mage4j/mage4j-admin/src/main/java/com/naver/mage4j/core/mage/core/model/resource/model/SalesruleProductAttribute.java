...
public class SalesruleProductAttribute implements java.io.Serializable {
	...
	public SalesruleProductAttribute(SalesruleProductAttributeId id, Website coreWebsite, EavAttribute eavAttribute, Salesrule salesrule, CustomerGroup customerGroup) {
		this.id = id;
