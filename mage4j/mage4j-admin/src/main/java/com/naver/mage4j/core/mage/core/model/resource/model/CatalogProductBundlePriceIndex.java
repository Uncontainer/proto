...
public class CatalogProductBundlePriceIndex implements java.io.Serializable {
	...
	public CatalogProductBundlePriceIndex(CatalogProductBundlePriceIndexId id, Website coreWebsite, CatalogProductEntity catalogProductEntity, CustomerGroup customerGroup, BigDecimal minPrice, BigDecimal maxPrice) {
		this.id = id;
