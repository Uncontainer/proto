...
/**
 * CatalogProductIndexPriceCfgOptTmpId generated by hbm2java
 */
@Embeddable
public class CatalogProductIndexPriceCfgOptTmpId implements java.io.Serializable {
	...
	public CatalogProductIndexPriceCfgOptTmpId(int entityId, short customerGroupId, short websiteId) {
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof CatalogProductIndexPriceCfgOptTmpId))
			return false;
		CatalogProductIndexPriceCfgOptTmpId castOther = (CatalogProductIndexPriceCfgOptTmpId)other;
