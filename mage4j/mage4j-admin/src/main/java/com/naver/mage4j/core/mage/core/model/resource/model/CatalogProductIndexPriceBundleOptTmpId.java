...
/**
 * CatalogProductIndexPriceBundleOptTmpId generated by hbm2java
 */
@Embeddable
public class CatalogProductIndexPriceBundleOptTmpId implements java.io.Serializable {
	...
	public CatalogProductIndexPriceBundleOptTmpId(int entityId, short customerGroupId, short websiteId, int optionId) {
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof CatalogProductIndexPriceBundleOptTmpId))
			return false;
		CatalogProductIndexPriceBundleOptTmpId castOther = (CatalogProductIndexPriceBundleOptTmpId)other;
