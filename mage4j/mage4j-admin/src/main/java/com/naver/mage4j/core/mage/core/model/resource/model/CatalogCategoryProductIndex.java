...
public class CatalogCategoryProductIndex implements java.io.Serializable {
	...
	public CatalogCategoryProductIndex(CatalogCategoryProductIndexId id, CatalogCategoryEntity catalogCategoryEntity, Store coreStore, CatalogProductEntity catalogProductEntity, short isParent, short visibility) {
		this.id = id;
	...
	public CatalogCategoryProductIndex(CatalogCategoryProductIndexId id, CatalogCategoryEntity catalogCategoryEntity, Store coreStore, CatalogProductEntity catalogProductEntity, Integer position, short isParent, short visibility) {
		this.id = id;
		this.catalogCategoryEntity = catalogCategoryEntity;
		this.coreStore = coreStore;
		this.catalogProductEntity = catalogProductEntity;
