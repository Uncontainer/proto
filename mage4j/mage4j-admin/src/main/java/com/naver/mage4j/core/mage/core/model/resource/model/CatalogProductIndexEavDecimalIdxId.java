...
/**
 * CatalogProductIndexEavDecimalIdxId generated by hbm2java
 */
@Embeddable
public class CatalogProductIndexEavDecimalIdxId implements java.io.Serializable {
	...
	public CatalogProductIndexEavDecimalIdxId(int entityId, short attributeId, short storeId, BigDecimal value) {
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof CatalogProductIndexEavDecimalIdxId))
			return false;
		CatalogProductIndexEavDecimalIdxId castOther = (CatalogProductIndexEavDecimalIdxId)other;
