...
/**
 * CatalogProductIndexPriceFinalIdx generated by hbm2java
 */
@Entity
@Table(name = "catalog_product_index_price_final_idx"
	, catalog = "magento")
public class CatalogProductIndexPriceFinalIdx implements java.io.Serializable {

	private CatalogProductIndexPriceFinalIdxId id;
	...
	public CatalogProductIndexPriceFinalIdx(CatalogProductIndexPriceFinalIdxId id) {
		this.id = id;
	}

	public CatalogProductIndexPriceFinalIdx(CatalogProductIndexPriceFinalIdxId id, Short taxClassId, BigDecimal origPrice, BigDecimal price, BigDecimal minPrice, BigDecimal maxPrice, BigDecimal tierPrice, BigDecimal baseTier, BigDecimal groupPrice, BigDecimal baseGroupPrice) {
		this.id = id;
	...
	public CatalogProductIndexPriceFinalIdxId getId() {
		return this.id;
	}

	public void setId(CatalogProductIndexPriceFinalIdxId id) {
		this.id = id;
	}
