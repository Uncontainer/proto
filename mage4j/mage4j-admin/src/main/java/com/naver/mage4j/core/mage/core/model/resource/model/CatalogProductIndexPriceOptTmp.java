...
/**
 * CatalogProductIndexPriceOptTmp generated by hbm2java
 */
@Entity
@Table(name = "catalog_product_index_price_opt_tmp"
	, catalog = "magento")
public class CatalogProductIndexPriceOptTmp implements java.io.Serializable {

	private CatalogProductIndexPriceOptTmpId id;
	...
	public CatalogProductIndexPriceOptTmp(CatalogProductIndexPriceOptTmpId id) {
		this.id = id;
	}

	public CatalogProductIndexPriceOptTmp(CatalogProductIndexPriceOptTmpId id, BigDecimal minPrice, BigDecimal maxPrice, BigDecimal tierPrice, BigDecimal groupPrice) {
		this.id = id;
	...
	public CatalogProductIndexPriceOptTmpId getId() {
		return this.id;
	}

	public void setId(CatalogProductIndexPriceOptTmpId id) {
		this.id = id;
	}
