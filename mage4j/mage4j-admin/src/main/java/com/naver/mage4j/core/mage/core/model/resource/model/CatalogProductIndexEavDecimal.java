...
public class CatalogProductIndexEavDecimal implements java.io.Serializable {
	...
	public CatalogProductIndexEavDecimal(CatalogProductIndexEavDecimalId id, CatalogProductEntity catalogProductEntity, EavAttribute eavAttribute, Store coreStore, BigDecimal value) {
		this.id = id;
