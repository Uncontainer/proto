...
/**
 * CatalogProductIndexPriceCfgOptIdx generated by hbm2java
 */
@Entity
@Table(name = "catalog_product_index_price_cfg_opt_idx"
	, catalog = "magento")
public class CatalogProductIndexPriceCfgOptIdx implements java.io.Serializable {

	private CatalogProductIndexPriceCfgOptIdxId id;
	...
	public CatalogProductIndexPriceCfgOptIdx(CatalogProductIndexPriceCfgOptIdxId id) {
		this.id = id;
	}

	public CatalogProductIndexPriceCfgOptIdx(CatalogProductIndexPriceCfgOptIdxId id, BigDecimal minPrice, BigDecimal maxPrice, BigDecimal tierPrice, BigDecimal groupPrice) {
		this.id = id;
	...
	public CatalogProductIndexPriceCfgOptIdxId getId() {
		return this.id;
	}

	public void setId(CatalogProductIndexPriceCfgOptIdxId id) {
		this.id = id;
	}
