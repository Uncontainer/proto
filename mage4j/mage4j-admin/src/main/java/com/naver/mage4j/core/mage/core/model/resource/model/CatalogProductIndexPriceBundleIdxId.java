...
/**
 * CatalogProductIndexPriceBundleIdxId generated by hbm2java
 */
@Embeddable
public class CatalogProductIndexPriceBundleIdxId implements java.io.Serializable {
	...
	public CatalogProductIndexPriceBundleIdxId(int entityId, short customerGroupId, short websiteId) {
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof CatalogProductIndexPriceBundleIdxId))
			return false;
		CatalogProductIndexPriceBundleIdxId castOther = (CatalogProductIndexPriceBundleIdxId)other;
