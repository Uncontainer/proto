...
/**
 * CatalogProductIndexPriceBundleIdx generated by hbm2java
 */
@Entity
@Table(name = "catalog_product_index_price_bundle_idx"
	, catalog = "magento")
public class CatalogProductIndexPriceBundleIdx implements java.io.Serializable {

	private CatalogProductIndexPriceBundleIdxId id;
	...
	public CatalogProductIndexPriceBundleIdxId getId() {
		return this.id;
	}

	public void setId(CatalogProductIndexPriceBundleIdxId id) {
		this.id = id;
	}
