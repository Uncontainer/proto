...
public class CatalogProductIndexGroupPrice implements java.io.Serializable {
	...
	public CatalogProductIndexGroupPrice(CatalogProductIndexGroupPriceId id, Website coreWebsite, CatalogProductEntity catalogProductEntity, CustomerGroup customerGroup) {
		this.id = id;
	...
	public CatalogProductIndexGroupPrice(CatalogProductIndexGroupPriceId id, Website coreWebsite, CatalogProductEntity catalogProductEntity, CustomerGroup customerGroup, BigDecimal price) {
		this.id = id;
		this.coreWebsite = coreWebsite;
		this.catalogProductEntity = catalogProductEntity;
		this.customerGroup = customerGroup;
