...
/**
 * CatalogProductIndexPriceCfgOptIdxId generated by hbm2java
 */
@Embeddable
public class CatalogProductIndexPriceCfgOptIdxId implements java.io.Serializable {
	...
	public CatalogProductIndexPriceCfgOptIdxId(int entityId, short customerGroupId, short websiteId) {
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof CatalogProductIndexPriceCfgOptIdxId))
			return false;
		CatalogProductIndexPriceCfgOptIdxId castOther = (CatalogProductIndexPriceCfgOptIdxId)other;
