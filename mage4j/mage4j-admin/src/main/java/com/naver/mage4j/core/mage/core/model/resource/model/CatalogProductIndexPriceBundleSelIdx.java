...
/**
 * CatalogProductIndexPriceBundleSelIdx generated by hbm2java
 */
@Entity
@Table(name = "catalog_product_index_price_bundle_sel_idx"
	, catalog = "magento")
public class CatalogProductIndexPriceBundleSelIdx implements java.io.Serializable {

	private CatalogProductIndexPriceBundleSelIdxId id;
	...
	public CatalogProductIndexPriceBundleSelIdx(CatalogProductIndexPriceBundleSelIdxId id) {
		this.id = id;
	}

	public CatalogProductIndexPriceBundleSelIdx(CatalogProductIndexPriceBundleSelIdxId id, Short groupType, Short isRequired, BigDecimal price, BigDecimal tierPrice, BigDecimal groupPrice) {
		this.id = id;
	...
	public CatalogProductIndexPriceBundleSelIdxId getId() {
		return this.id;
	}

	public void setId(CatalogProductIndexPriceBundleSelIdxId id) {
		this.id = id;
	}
