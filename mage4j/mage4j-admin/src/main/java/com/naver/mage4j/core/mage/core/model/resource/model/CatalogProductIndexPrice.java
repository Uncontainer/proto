...
public class CatalogProductIndexPrice implements java.io.Serializable {
	...
	public CatalogProductIndexPrice(CatalogProductIndexPriceId id, Website coreWebsite, CatalogProductEntity catalogProductEntity, CustomerGroup customerGroup) {
		this.id = id;
	...
	public CatalogProductIndexPrice(CatalogProductIndexPriceId id, Website coreWebsite, CatalogProductEntity catalogProductEntity, CustomerGroup customerGroup, Short taxClassId, BigDecimal price, BigDecimal finalPrice, BigDecimal minPrice, BigDecimal maxPrice, BigDecimal tierPrice, BigDecimal groupPrice) {
		this.id = id;
		this.coreWebsite = coreWebsite;
		this.catalogProductEntity = catalogProductEntity;
		this.customerGroup = customerGroup;
