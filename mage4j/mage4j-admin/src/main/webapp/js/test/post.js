$(function() {
	$("#edit_area").on("click", "button#add_image_button", function(ev) {
//		addPostImg();
	});
	
	$("#edit_area").on("click", "button#add_text_button", function(ev) {
		addPostText();
	});
	
	$("#edit_area").on("click", "button#preview_button", function(ev) {
//		preview();
	});
	
	function addPostText() {
		$("#post_top").append($("#tpl_post_unit_text").html());
//		this._initFlicking();
	}
	
	$("#content_area").on("click", "._up_component", function(ev) {
		alert('up');
	});
...
//		var elFileBrowse = this._getElement("file_select");
//		var sUploadUrl = "/upload/photos";
